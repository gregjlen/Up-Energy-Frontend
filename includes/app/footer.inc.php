            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="footer-widget widget-contact">
                        <div class="widget-content">
                            <ul>
                                <li class="phone"><a href="tel:+01061245741"> 04 65 84 64 74</a></li>
                                <li class="email"><a href="mailto:contact@up-energy.fr">contact@up-energy.fr</a></li>
                                <li class="address">
                                    <p>132 rue Bossuet<br>
                                        69006 <br>Lyon</p>
                                </li>
                            </ul>
                        </div>
