        ...
        <div class="contact-panel contact-panel-3">
            <div class="heading heading-light heading-6">
                ...
                <p class="heading-desc">
                    Un conseiller vous rappelle pour discuter de votre projet !
                </p>
                <div class="contact-quote"> <img src="assets/images/icons/noteicon.png" alt="icon"/>
                    <p>Vous voulez parler directement avec un de nos commerciaux de vos travaux et de votre projet ?
                        Appelez nous ! <a href="tel:01061245741">04 65 84 64 74</a></p>
                </div>
            </div>
            <div class="contact-card">
                <div class="contact-body">
                    ...
                    <!-- Change or deletion of the name attributes in the input tag will lead to empty values on record submission-->
                    <!-- Change or deletion of the name attributes in the input tag will lead to empty values on record submission-->
                    <form action='https://forms.zohopublic.eu/davylaurent/form/Demandeweb/formperma/mYrwvsd-II6yLvt4vvqSUpFjeik9y8p_l0GPgW8o95w/htmlRecords/submit' name='form' id='form' method='POST' accept-charset='UTF-8' enctype='multipart/form-data'>
